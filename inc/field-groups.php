...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			'key' => 'field_other_files',
			'label' => __('Other files', 'clade'),
			'name' => 'data_other_files',
			'type' => 'repeater',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
			...
			'max' => '',
			'layout' => 'table',
			'button_label' => __('Add file', 'clade'),
			'sub_fields' => array (
				array (
					'key' => 'field_other_files_file',
					'label' => __('File', 'clade'),
					'name' => 'file',
					'type' => 'file',
					'instructions' => '',
				...
				// array (
				// 	'key' => 'field_other_files_format',
				// 	'label' => __('Format', 'clade'),
				// 	'name' => 'format',
				// 	'type' => 'text',
				// 	'instructions' => '',
				// 	'required' => 1,
